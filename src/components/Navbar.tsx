      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="hidden xs:block text-[11px] text-slate-500 dark:text-slate-400 -mt-0.5 truncate">
              Applications &amp; Follow-up Pipeline
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
          {onOpenSettings && (
            <button
              ...
              aria-label="Settings"
              title="Settings"
              className="p-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500/50 cursor-pointer shadow-2xs"
            >
