...
export default function ApplicationList({
  ...
  return (
    <div className="space-y-4">
      {/* Header with View Mode Switcher and Status Filter */}
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          {activeTab === 'list' && (
            <select
              ...
              className="text-xs px-3 py-1.5 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-200 font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/50 cursor-pointer shadow-xs"
      ...
      {applications.length === 0 ? (
        ...
        <div className="divide-y divide-slate-200 dark:divide-slate-800 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 overflow-hidden shadow-xs transition-all">
          {filteredApplications.length === 0 ? (
            ...
            <div className="p-10 text-center space-y-3">
              ...
              >
                Clear filter to view all {applications.length} applications
              </button>
            </div>
          ) : (
        ...
        /* PIPELINE VIEW (Responsive scroll container for mobile/tablet) */
